...
public class ViewDetailsAreaJPanel extends javax.swing.JPanel {
    ...
    private RoadConstructionWorkRequest request;
    Enterprise enterprise;
    EcoSystem business;
    Network network;
    PublicWorksOrganization organization;
...
//    }
    ...
    ViewDetailsAreaJPanel(JPanel userProcessContainer, RoadConstructionWorkRequest request, UserAccount account, Enterprise enterprise, EcoSystem business, Network network, PublicWorksOrganization organization) {
...
//            FileOutputStream out = new FileOutputStream(newname);
    ...
    */
    private void populateFields(){
        ...
        inventoryReBtn.setEnabled(false);
        ...
        if(request.getReceiver()!=null)
        {
             if(request.getReceiver()==userAccount)
            {
                ...
                //Waiting for Inventory team approval
                else if(request.getStatus().equals("Waiting for Inventory team approval") || (request.getStatus().equals("Waiting for Finance team approval")) 
                        || (request.getStatus().equals("Forwarded")))
                //else if(request.getStatus().equals("Forwarded"))
                {
                    resultJTextField.setEnabled(false);
                    submitJButton.setEnabled(false);
                    inventoryReBtn.setEnabled(false);
                ...
                else
                {
                    ...
                    inventoryReBtn.setEnabled(true);
                }
...
//        String product = "";
    ...
    private void initComponents() {
        ...
        inventoryReBtn = new javax.swing.JButton();
        ...
        picLabel.setText("Image Request");
        picLabel.setVerticalAlignment(javax.swing.SwingConstants.BOTTOM);
        ...
        inventoryReBtn.setFont(new java.awt.Font("Montserrat", 0, 15)); // NOI18N
        inventoryReBtn.setText("Place Request to Inventory");
        inventoryReBtn.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                inventoryReBtnActionPerformed(evt);
            }
        });
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(picLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 303, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void submitJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitJButtonActionPerformed
        ...
        if(request.getDependencies().size()!=0)
        {
            ...
            if(next.getStatus().equals("Completed"))
            {
                ...
                JOptionPane.showMessageDialog(null, "Request 1 processed successfully");
            ...
            {
                JOptionPane.showMessageDialog(null, "Request 2 cannot be closed right now.");
                return;
            }
        }
        ...
        JOptionPane.showMessageDialog(null, "Request 3 processed successfully");
    ...
    private void inventoryReBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_inventoryReBtnActionPerformed
        ...
        RequestInventoryTeamJPanel processWorkRequestJPanel = new RequestInventoryTeamJPanel(userProcessContainer, userAccount, organization, enterprise, business, request);
        ...
        // TODO add your handling code here:
    }//GEN-LAST:event_inventoryReBtnActionPerformed


    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JButton btnBack;
    private javax.swing.JLabel dateLabel;
    private javax.swing.JButton inventoryReBtn;
