 ...
 * @author pranav
 */
public class RequestStreetLightJPanel extends javax.swing.JPanel {
    ...
    /**
     * Creates new form RequestStreetLightJPanel
     */
    public RequestStreetLightJPanel(JPanel userProcessContainer, UserAccount account, Enterprise temp, String PowerDepartmentOrganization) {
        initComponents();
        this.userProcessContainer = userProcessContainer;
        this.enterprise = temp;
        this.userAccount = account;
        this.type = PowerDepartmentOrganization;
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Raise Complaint for Street Light");
    ...
    private void requestTestJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_requestTestJButtonActionPerformed
...

        {
            ...
            for (Organization o : enterprise.getOrganizationDirectory().getOrganizationList()){
                if (o instanceof PowerDepartmentOrganization){
                    org = o;
                    break;
                }
            }
