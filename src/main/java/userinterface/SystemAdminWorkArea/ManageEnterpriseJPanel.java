...
public class ManageEnterpriseJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        submitJButton.setBackground(new java.awt.Color(158, 226, 117));
    ...
    private void submitJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitJButtonActionPerformed
        ...
        if(name.isEmpty())
        {
            JOptionPane.showMessageDialog(null, "Enter " + type + " some text");
            return;
        }*/
        ...
        if(eflag)
        {
            JOptionPane.showMessageDialog(null, "The enterprise " + type + " already exists in this network");
            return;
        }
        
        if(nameflag)
        {
            JOptionPane.showMessageDialog(null, "An enterprise with the same name already exists in the network");
            return;
        }
